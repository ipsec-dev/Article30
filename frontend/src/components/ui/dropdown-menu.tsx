...
const FOCUS_ACCENT_CLASSES = 'focus:bg-accent focus:text-accent-foreground';
const OUTLINE_SELECT_CLASSES = 'outline-hidden select-none';
const SVG_NON_INTERACTIVE_CLASSES = '[&_svg]:pointer-events-none [&_svg]:shrink-0';
const SVG_DEFAULT_SIZE_CLASSES = "[&_svg:not([class*='size-'])]:size-4";
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        OUTLINE_SELECT_CLASSES,
        'data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8',
        SVG_NON_INTERACTIVE_CLASSES,
        SVG_DEFAULT_SIZE_CLASSES,
        className,
      )}
      {...props}
    />
